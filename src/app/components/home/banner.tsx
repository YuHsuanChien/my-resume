  ...
  return (
    ...
    >
            ...
            .map((_, index) => {
              return (
                <div
                  ...
                  className="w-3 h-3 rounded-full bg-white opacity-0 dot"
                ></div>
              );
            })}
        </div>
      ...
      <div className="flex flex-col items-center justify-center mt-10  text-white">
        ...
        <h5 className="h4 md:mt-3 xl:mt-5">I&apos;m a Full-end engineer</h5>
      </div>
        ...
        <li>
          ...
          >
            <span
              ...
              style={{ '--h': '32px', '--hh': '6.5px' } as React.CSSProperties}
            ></span>
            <span
