...
export default function Banner() {
	const JKiconEl = React.useRef<HTMLDivElement>(null);
	...
	return (
		<section className='w-full h-screen min-h-[600px] 2xl:min-h-[900px] overflow-hidden relative flex flex-col items-center justify-center before:content-[""] before:absolute before:inset-0 before:bg-[url("/banner/bg-banner.jpg")] before:bg-cover before:bg-center before:bg-no-repeat before:brightness-50 before:z-[-1]'>
			<div
				className='w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 xl:w-64 xl:h-64 2xl:w-80 2xl:h-80'
				ref={JKiconEl}>
				<img
